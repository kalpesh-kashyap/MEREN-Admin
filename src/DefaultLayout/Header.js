                    ...
                    <li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                            ...
                            <a className="dropdown-item preview-item">
                                ...
                                <div
                                    className="preview-item-content d-flex align-items-start flex-column justify-content-center">
                                    <h6 className="preview-subject ellipsis mb-1 font-weight-normal">Cregh send you a
                                        message</h6>
                        ...
                        <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                            ...
                            <a className="dropdown-item preview-item">
                                ...
                                <div
                                    ...
                                    <p className="text-gray ellipsis mb-0"> Just a reminder that you have an event
                                        today </p>
                                </div>
                            </a>
                            <div className="dropdown-divider"/>
